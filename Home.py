    ...
    if not df_plot.empty:
        for metric in metrics:
            ...
            with col1:
                ...
                weekly_avg = df_plot_all[df_plot_all['DATE'].between(pd.Timestamp(selected_date - pd.DateOffset(weeks=1)), pd.Timestamp(selected_date - pd.DateOffset(days=1)))][metric].mean()
